...
import '../../main.dart';
import '../../model/payment_list_response.dart';
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(locale.paymentHistory, style: boldTextStyle()).paddingAll(16),
                  ...
                  itemBuilder: (p0, index) {
                    ...
                    return Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Marquee(child: Text('${locale.transactionId} ${data.txnId.validate()}', style: primaryTextStyle())),
                          8.height,
                          Row(
