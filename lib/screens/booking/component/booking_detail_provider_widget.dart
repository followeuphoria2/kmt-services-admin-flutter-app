    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ImageBorder(src: widget.providerData.profileImage.validate(), height: 50),
              16.width,
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Marquee(
                    child: Text('${widget.providerData.displayName}', style: boldTextStyle()),
                  ),
                  6.height,
                  DisabledRatingBarWidget(rating: widget.providerData.providersServiceRating.validate()),
                ],
              ).expand(),
              Image.asset(ic_verified, height: 22, width: 22, color: verifyAcColor),
            ],
          ),
          16.height,
          TextIcon(
