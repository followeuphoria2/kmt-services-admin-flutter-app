              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (showServiceName) Text('${locale.service} : ${data.serviceName.validate()}', style: primaryTextStyle(size: 14), maxLines: 1, overflow: TextOverflow.ellipsis).paddingTop(8),
                    //Text('${locale.lblService}: ${data.serviceName.validate()}', style: primaryTextStyle(size: 14), maxLines: 1, overflow: TextOverflow.ellipsis).paddingTop(8),
